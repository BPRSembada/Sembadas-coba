      ...
      <Navbar.Collapse id="basic-navbar-nav">
        ...
        <Nav className="me-auto">
          ...
          >
            ...
            <NavDropdown.Item href="./investasi">Investasi</NavDropdown.Item>
          </NavDropdown>
        ...
        <Nav className="bar-sosialmedia">
          <a href="">
            <Icon path={mdiTwitter} size={1} className="icon-navBar" />
          </a>
          <a href="">
            <Icon path={mdiFacebook} size={1} className="icon-navBar" />
          </a>
          <a
            href="https://instagram.com/bpr.sembada?igshid=ZDdkNTZiNTM="
            target="_blank"
          >
            <Icon path={mdiInstagram} size={1} className="icon-navBar" />
          </a>
        </Nav>
      </Navbar.Collapse>
    </Navbar>
