  ...
  const CardDoc = () => {
    if (valueDoc === "Testimonial") {
      return Testimonial.map((item, ind) => {
        return (
          <Card style={{ width: "25rem" }} key={ind}>
    ...
    <div>
      <div className="container-projects">
        ...
        {/* <p className="sub-title">
          ...
          at. Ea tempora quod cupiditate deleniti corporis voluptatum iure,
          minima inventore quos sequi sit, impedit similique beatae animi
          laborum totam?
        </p> */}
        <div className="slide">
      ...
      <div className="cont-cart-keunggulan">
        <h1>{valueDoc}</h1>
        <div className="cont-showCart">
          {/* {CardDoc(valuDesDoc)} */}
          {/* {valuDesDoc.map((item, ind) => {
            return (
              <Card style={{ width: "25rem" }} key={ind}>
                <Card.Img
...
export default CombinedProjectsSlider;
