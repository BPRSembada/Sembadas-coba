...
import { API_Kredit, API_Simpanan } from "../database/APIs";
...
const FormSimpanan = () => {
  ...
  const ajukanSimpanan = () => {
    ...
    if (
      ...
      const Datas = {
        SimDate: new Date().toLocaleString(),
        SimJenisSimpanan: jenisSimpanan,
        SimNama: nama,
        SimTlpn: noTelephone,
        SimEmail: email,
        SimProvinsi: prov,
        SimKota: kota,
        SimPenempatanDana: penempatanDana,
      };
      Axios.post(`${API_Simpanan}`, Datas).then((res) => {
    ...
    <div>
      <div className="hero-section-formSimpanan">
        <div className="containers-visi">
          <h1>Form Simpanan BPR Sembada</h1>
          {/* <p>
        ...
        <div className="cont-formss">
          ...
          <div className="form-pertama">
            <div className="form-item1">
              <Form.Label htmlFor="basic-url">Pilih jenis tabungan</Form.Label>
              <Form.Select
              ...
              >
                <option value="kosong">Jenis tabungan</option>
