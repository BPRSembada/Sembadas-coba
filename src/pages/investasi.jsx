  ...
  return (
    <div>
      ...
      >
        ...
        <p>
          Hadir sebagai layanan pinjaman yang dapat membantu usaha Anda dalam
          pembiayaan investasi baik investasi baru, modernisasi dan peremajaan.
          Contohnya seperti membeli peralatan mesin untuk usaha, membangun
          pabrik atau kantor baru, renovasi atau memperluas area
          kantor, dan lain-lain
        </p>
      </div>
        ...
        >
          <div className="site-prasarat-kredit">
            ...
            <ol>
              ...
              <li>
                Jangka waktu kredit maksimal 1 tahun sejak akad (bisa di
                perpanjang)
              </li>
              <li>Plafon kredit hingga Rp 2 Milyar</li>
              <li>
                Prosentase pembiayaan (loan to value) hingga 60% dari nilai
                agunan berdasarkan penilaian bank
              </li>
              <li>
                Agunan:
                <ul>
                  <li>
                    • SHM (Sertifikat Hak Miliki)/ SHGB (Sertifikat Hak Guna
                    Bangunan) untuk rumah, apartemen, ruko, rukan, atau tanah
                    kosong untuk di bangun.
                  </li>
                </ul>
              </li>
              <li>
                Bebas biaya appraisal untuk kerdit plafon &mt; RP. 300 juta
              </li>
              <li>
                Sistem pembayaran:
                <ul>
              ...
              <li>
                Fasilitas Take-Over pengambilalihan KPR/Kredit Pengambilalihan
                dari bank lain, dengan maksimum limit kredit sebesar outstanding
                (sisa pinjaman) terakhir di bank asal atau limit kredit baru
                sesuai perhitungan Bank Sembada. Jika jumlahnya lebih besar dari
                outstanding terakhir di bank asal, Anda bisa memanfaatkannya
                untuk memenuhi berbagai kebutuhan lain.
              </li>
              <li>
                Fasilitas Top-up atau penambahan limit kerdit yg telah berjalan
                di bank Sembada dengan tamabahan limit kredit. Sehingga anda
                dapat memenuhi beragam kebutuhan lainnya
              </li>
