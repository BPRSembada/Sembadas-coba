    ...
    <div>
      ...
      <div class="container-strategi">
        <div class="strategi">
          ...
          <p data-aos="fade-right" data-aos-once="true">
            Memperluas jenis produk yang ditawarkan untuk meningkatkan kepuasan
            nasabah dalam bertransaksi di BPR kami.
          </p>
          <p data-aos="fade-right" data-aos-once="true">
        ...
        <div class="strategi">
          ...
          <p data-aos="fade-left" data-aos-once="true">
            Memiliki pemimpin yang mendorong dan menunjukkan dukungan yang jelas
            untuk perubahan budaya, sehingga menjadi model yang baik dalam
            perilaku yang bisa menunjukan integritas dari suatu BPR, juga dapat
            memotivasi karyawan untuk membangun budaya kerja yang lebih baik.
          </p>
          <p data-aos="fade-left" data-aos-once="true">
          ...
          <p data-aos="fade-left" data-aos-once="true">
            Membangun komunikasi mengenai perubahan budaya yang akan dilakukan,
            tujuan perusahaan, dan nilai-nilai yang dibangun dalam suatu
            perusahaan.
          </p>
          <p data-aos="fade-left" data-aos-once="true">
